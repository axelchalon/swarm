// @TODO bug when creating a text, typing some text and creating another one (first text is set to empty)
...
class Canvas extends Component {
	render() {
		...
		var flags = store.getState().flags;
		...
		return (
		<div className={'plus' in flags ? 'extended' : ''} id="canvas" onMouseDown={onMouseDown}>
...
socket.on('connect', function() {
	...
	store.dispatch({type: 'CHANGE_SWARM', swarmName: room_name})
	store.dispatch({type: 'CHANGE_FLAGS', flags: flags})
